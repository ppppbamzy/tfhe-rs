    ...
    (
        ...
        $name:ident {
         ...
         paste! {
            ...
            $(#[$outer])*
            // #[cfg_attr(doc, cfg(feature = "integer"))]
...
//impl FheEncrypt<(u128, u128)> for GenericInteger<FheUint256Parameters> {
//    #[track_caller]
//    fn encrypt(value: (u128, u128), key: &ClientKey) -> Self {
//        let id = <FheUint256Parameters as IntegerParameter>::Id::default();
...
// impl FheTryEncrypt<crate::integer::U256, ClientKey> for FheUint256 {
//     type Error = crate::typed_api::errors::Error;
//
//     fn try_encrypt(value: U256, key: &ClientKey) -> Result<Self, Self::Error> {
//         let id = <FheUint256Parameters as IntegerParameter>::Id::default();
