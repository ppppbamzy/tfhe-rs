...
pub(in crate::typed_api::booleans) type FheBoolClientKey = GenericBoolClientKey<StaticBoolParameters>;
pub(in crate::typed_api::booleans) type FheBoolServerKey = GenericBoolServerKey<StaticBoolParameters>;
pub(in crate::typed_api::booleans) type FheBoolPublicKey = GenericBoolPublicKey<StaticBoolParameters>;
