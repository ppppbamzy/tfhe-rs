...
use tfhe::core_crypto::prelude::{
    ...
    PlaintextCount, PlaintextList, Polynomial, SecretRandomGenerator,
};
...
pub fn multi_bit_pbs_external_product(
    ...
    let mut a_monomial = Polynomial::new(0u64, fbsk.polynomial_size());
    let mut fourier_a_monomial = FourierPolynomial::new(a_monomial.polynomial_size());
